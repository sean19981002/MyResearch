...
> + ## base graph (一張) -> Vertex, Edge<前七天的轉推>
> + ## data graph：
>   + ### weight + v,e, <用後七後的轉推>
>   + ### data graph: 先看 last 7 days tweet 分布, seperate by hours(1,2,..., 72 hr)
> + ## next week：
>   + ### User profile -> locaiton clustering
>   + ### last 7th tweets distribution
>   + ### base graph(first)